                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <div className="flex items-baseline gap-3 mb-6">
                            <span className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        {product.features.map((feature, index) => (
                                            ...
                                            >
                                                <div className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-primary/20 border border-primary flex items-center justify-center">
                        ...
                        >
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary text-black font-bold py-5 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-[0_0_30px_rgba(0,243,255,0.3)] hover:shadow-[0_0_40px_rgba(0,243,255,0.6)] flex items-center justify-center gap-3 text-lg"
